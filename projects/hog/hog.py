...
def is_swap(player_score, opponent_score):
    ...
    a = abs(player_score%10 - opponent_score%10)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if(who==0):
            ...
            if(feral_hogs and abs(strategy-add_score0)==2 ):
                score0+=3
            opponent_score=score1
            add_score0 = take_turn(strategy,opponent_score,dice)  
            score0+=add_score0
            ...
            if(feral_hogs and abs(strategy-add_score1)==2):
               score1+=3 
            opponent_score=score0
            add_score1 = take_turn(strategy,opponent_score,dice)
            score1 += add_score1
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(score+num,opponent_score) and opponent_score > score+num:
        return 0
    elif num >= cutoff and  (not is_swap(score+num,opponent_score)):
        return 0
    return num_rolls  # Replace this statement
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    return swap_strategy(score,opponent_score,6,4)  # Replace this statement
    # END PROBLEM 12
